        ...
        <Card className="bg-white/5 border border-white/10 backdrop-blur-xl shadow-xl">
          ...
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-slate-400 text-sm">
              Join <span className="text-cyan-400">BidZen</span> marketplace
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <label className="flex items-center gap-2 p-2 rounded-lg border border-white/10 bg-slate-900 hover:border-cyan-500/40 transition">
