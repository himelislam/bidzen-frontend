...
const getButtonClasses = (variant: string = "default", size: string = "default", className?: string) => {
  ...
  return cn(baseClasses, variantClasses[variant as keyof typeof variantClasses], sizeClasses[size as keyof typeof sizeClasses], className);
}
icon: "size-8",
  "icon-xs":
